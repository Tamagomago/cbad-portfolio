...
<body>
<div class="container-fluid g-0 min-vh-100 d-flex align-items-center justify-content-center">
  <!-- sidebar (3 cols), main content (9 cols) -->
  <div class="row g-0 w-100">
    <aside class="col-12 col-md-3 h-lg-100">
      <?php include __DIR__ . '/menu.php'; ?>
    </aside>
    <main class="col-12 col-md-9 d-flex align-items-center justify-content-center">
      <div class="design-surface d-flex align-items-center justify-content-center position-relative w-100">
        <!-- design surface -->
        <div class="overlay position-absolute"></div>
        <div class="d-flex align-items-stretch">
          <!-- Image placeholder -->
          <div class="placeholder-box bg-secondary"></div>
          
          <!-- Content -->
          <div class="content-box d-flex flex-column justify-content-center px-4">
            ...
            <!-- See my works button -->
            <div class="d-flex">
              <button type="button" class="btn btn-outline-light w-auto d-flex align-items-center gap-2">
                See my works
              </button>
            </div>
            <!-- About me -->
            <div class="about-me mt-4">
              <p class="fs-6 txt-muted">
                ...
                of Saint La Salle – Bacolod. I enjoy building clean and user-friendly applications. </p>
            </div>
          </div>
        </div>
      </div> <!-- close .design-surface -->
    </main>
  </div>
</div>
